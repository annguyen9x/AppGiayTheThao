...
import com.annguyen.giaythethao.adapter.GiayVansAdapter;
...
public class GiayVansActivity extends AppCompatActivity {
    private Toolbar toolbarGiayVans;
    private ListView listViewGiayVans;
    private ArrayList<SanPham> arrayListSP;
    private GiayVansAdapter giayVansAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_giay_vans);
    ...
    private void widget() {
        toolbarGiayVans = findViewById(R.id.toolbarGiayVans);
        listViewGiayVans = findViewById(R.id.listViewGiayVans);

        //setAdapter cho ListView
        arrayListSP = new ArrayList<>();
        giayVansAdapter = new GiayVansAdapter(arrayListSP, getApplicationContext());
        listViewGiayVans.setAdapter(giayVansAdapter);
    ...
    private void getIDLoaiSP() {
        ...
        Log.d("idLoaiSP: ", idLoaiSP+"");
    }

    private void setMyActionBar() {
        setSupportActionBar(toolbarGiayVans);
        getSupportActionBar().setHomeButtonEnabled(true);//Bật nút Home cho ActionBar
        toolbarGiayVans.setNavigationIcon(android.R.drawable.ic_media_previous);//set Icon cho ActionBar
        //Cài đặt sự kiện click
        toolbarGiayVans.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if ( response != null && response.length() != 2 ) {
                            ...
                            listViewGiayVans.removeFooterView(progressbarFooterView);
                            ...
                            giayVansAdapter.notifyDataSetChanged();
                        }else{
    ...
    private void loadingDataIconInListView() {
        ...
        listViewGiayVans.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        listViewGiayVans.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what){
                case 0:
                    listViewGiayVans.addFooterView(progressbarFooterView);//thêm biểu tượng nút Load, nếu lần đầu chưa có dl
                    break;
                case 1:
