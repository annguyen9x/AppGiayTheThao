...
public class DangKy extends AppCompatActivity {
    ...
    private EditText editTextTen, editTextMatKhau, editTextEmail, editTextDienThoai, editTextghiChu, editTextDiaChi;
    ...
    private void widget() {
        ...
        editTextDiaChi = findViewById(R.id.editTextghiChuDK);
        editTextghiChu = findViewById(R.id.editTextDiaChiDK);
    ...
    private void setDangKyTaiKhoan(){
        ...
        buttonXacNhanDangKy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String ghiChu = editTextghiChu.getText().toString().trim();
